...
--
-- Host: 127.0.0.1
-- Tempo de geração: 17-Ago-2022 às 22:00
...
INSERT INTO `posts` (`post_id`, `id_conteudo`, `trilha_id`, `user_id`, `post_title`, `post`) VALUES
(36, 86, 51, 29, 'Reputação dos profissionais de programação', '<p>Os profissionais de programa&ccedil;&atilde;o s&atilde;o muito requisitados. Os sal&aacute;rios s&atilde;o muito atrativos.</p>\n\n<p><em>M&eacute;dia salarial dos profissionai</em>s:</p>\n\n<p>Junior: &nbsp; &nbsp; &nbsp; R$ &nbsp; 4.000,00<br />\nS&ecirc;nior: &nbsp; &nbsp; &nbsp; R$ &nbsp; 8.000,00<br />\nPleno: &nbsp; &nbsp; &nbsp; &nbsp;R$ 10.000,00</p>\n'),
(44, 86, 51, 29, 'O que faz um Programador?', '<p>O <strong>programador </strong>&eacute; o profissional que cria, desenvolve e mant&eacute;m diferentes tipos de softwares em sistemas amplos ou para uso em computadores pessoais. Ele usa linguagens de programa&ccedil;&atilde;o, como html, java, c++, para criar comandos em programas, criando novas funcionalidades e utilidades.</p>\n\n<p>Os programadores desenvolvem e aperfei&ccedil;oam websites, aplicativos, programas de computador, sistemas operacionais, sistemas de empresas, redes sociais, com infinitas possibilidades de atua&ccedil;&atilde;o quando falamos de algo t&atilde;o extenso quanto a rede e a tecnologia. Por isso, &eacute; um profissional cada vez mais essencial em qualquer ramo do mercado de trabalho.</p>\n\n<p>O <strong>programador </strong>tamb&eacute;m lida com coleta de dados de usu&aacute;rios e posterior an&aacute;lise para tomadas de decis&otilde;es assertivas e bem fundamentadas no desenvolvimento de produtos e servi&ccedil;os.</p>\n\n<pre>\n<code class=\"language-javascript\">  &lt;body&gt; \n      &lt;img src=\"imagem.jpg\" alt=\"\" /&gt;\n  &lt;/body&gt;</code></pre>\n\n<p>&nbsp;</p>\n');
