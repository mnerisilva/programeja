...
--
-- Host: 127.0.0.1
-- Tempo de geração: 08-Ago-2022 às 22:20
...
CREATE TABLE `anotacao` (
  ...
  `anotacao_conteudo` text COLLATE utf8mb4_swedish_ci NOT NULL
...
INSERT INTO `anotacao` (`anotacao_id`, `id_conteudo`, `trilha_id`, `user_id`, `anotacao_conteudo`) VALUES
(1, 0, 0, 0, ''),
(2, 0, 0, 0, ''),
(3, 0, 0, 0, ''),
(4, 0, 0, 0, ''),
...
(29, 'Adriele Santos', 'nana@xpto.com', '2', 2, '48488999999', 'Rua das Casas', '15', 'funcods', '88888888', 'Centro', 'São José', 'SC', '99999999999', '30', 'nana@xpto.com', 'e10adc3949ba59abbe56e057f20f883e', 'nana@dfddfsd', 'https://userstock.io/data/wp-content/uploads/2017/06/pexels-photo-27411-300x300.jpg', ''),
...
--
ALTER TABLE `anotacao`
  MODIFY `anotacao_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;
...
--
ALTER TABLE `user_trilha`
  MODIFY `usertrilha_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
