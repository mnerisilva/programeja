...
--
-- Host: 127.0.0.1
-- Tempo de geração: 25-Ago-2022 às 21:49
...
(1, 'css', 'css', '<i class=\"fa-brands fa-css3-alt\"></i>'),
(2, 'html', 'html', '<i class=\"fa-brands fa-html5\"></i>'),
(3, 'javascritpt', 'js', '<i class=\"fa-brands fa-js\"></i>'),
(4, 'sem categoria', 'sem categoria', '<i class=\"fa-solid fa-genderless\"></i>'),
(6, 'Lógica de programação', 'Lógica', '<i class=\"fa-solid fa-boxes-stacked\"></i>');
...
(5, 5, 'HTML em 7 minutos', '0X1OUnQuY5c', 2, 4),
(6, 6, '10 ideias de projetos em HTML e CSS para adicionar no portfólio!', 'y4ltLH9iK8E', 2, 4),
(84, 84, 'HTML o ESSENCIAL pra programação Front-end', 'qHHXjEmOJyk', 2, 4),
(85, 85, 'Como INSERIR IMAGEM no HTML - COMPLETO!!!! Passo a Passo!', '6U0l5cVAef0', 2, 4),
(86, 86, 'HTML in 100 Seconds', 'ok-plXXHlWw', 2, 4),
(87, 87, 'O que é HTML 2022 - Hostinger Brasil', 'jOqaeGC90D0', 2, 4),
(88, 88, 'Aprendendo o básico de html (web) | Web #1', 'DG8b1Ud4Mr8', 2, 4),
(89, 89, 'Curso de JavaScript para iniciantes - aprenda os fundamentos de JavaScript', 'hyMCPZNLXps', 2, 4),
(90, 90, 'JAVASCRIPT FUNDAMENTOS - 044 - PROPRIEDADES E MÉTODOS PRIVADOS', 'lbN2c989Pa8', 2, 4),
(91, 91, 'Tutorial JavaScript - fundamentos da linguagem', 'x9KfwLds33Y', 2, 4),
(92, 92, 'JavaScript para Iniciantes 2020 - 100% Prático!', 'WcIIUmDch94', 2, 4),
(93, 93, 'APRENDA CSS EM 10 MINUTOS', 'lsxBlQWNdUQ', 2, 4),
(94, 94, 'CSS3: Aprenda como Funciona a Estrutura CSS', 'qdTDp7Wr0DU', 2, 4),
(95, 95, 'O QUE É CSS? (SELETORES, PROPRIEDADES E VALORES)', 'LWU2OR19ZG4', 2, 4),
(96, 96, 'CSS (Cascading Style Sheets) // Dicionário do Programador', '229xfk3EEM8', 2, 4),
(97, 97, 'A malas sem alça', '0X1OUnQuY5c', 2, 4),
(98, 98, 'Como a Internet funciona? - @Curso em Vídeo HTML5 e CSS3', 'nlO5hySqJFA', 2, 4),
(99, 99, 'Lógica de Programação - Aula 01 - Introdução', '4ZAOWlZRbZk', 2, 4),
(100, 100, 'Aprendendo Lógica de Programação', 'AhHPE_93nAk', 2, 4),
(102, 102, 'Fetch API', '', 4, 0),
(103, 103, 'Funções javascript auto executáveis', '', 4, 0);
...
(102, 4, 'Fetch API', 3, 0),
(103, 4, 'Funções javascript auto executáveis', 3, 0);
...
(104, 102, 0, 29, 'Fetch API', '<pre>\n<code class=\"language-javascript\">// GET WEATHER FROM API PROVIDER\nfunction getWeather(latitude, longitude){\n    let api = `http://api.openweathermap.org/data/2.5/weather?lat=${latitude}&amp;lon=${longitude}&amp;appid=${key}`;\n\n    fetch(api)\n        .then(function(response){\n            let data = response.json();\n            return data;\n        })\n        .then(function(data){\n            weather.temperature.value = Math.floor(data.main.temp - KELVIN);\n            weather.description = data.weather[0].description;\n            weather.iconId = data.weather[0].icon;\n            weather.city = data.name;\n            weather.country = data.sys.country;\n        })\n        .then(function(){\n            displayWeather();\n        });\n}</code></pre>\n\n<p>&nbsp;</p>\n', '2022-08-25 18:30:13', '2022-08-25 18:30:13'),
(105, 103, 0, 29, 'Funções javascript auto executáveis', '<p><strong>IIFE</strong> (Immediately Invoked Function Expression) &eacute; uma fun&ccedil;&atilde;o em JavaScript que &eacute; executada assim que definida.</p>\n\n<p>&Eacute; um <strong><span style=\"color:#e74c3c\">Design Pattern</span></strong> tamb&eacute;m conhecido como Self-Executing Anonymous Function e cont&eacute;m duas partes principais. A primeira &eacute; a fun&ccedil;&atilde;o an&ocirc;nima cujo escopo l&eacute;xico &eacute; encapsulado entre par&ecirc;nteses. Isso previne o acesso externo &agrave;s vari&aacute;veis declaradas na IIFE, bem como evita que estas vari&aacute;veis locais poluam o escopo global.</p>\n\n<p>A segunda parte corresponde &agrave; cria&ccedil;&atilde;o da express&atilde;o (), por meio da qual o interpretador JavaScript avaliar&aacute; e executar&aacute; a fun&ccedil;&atilde;o.</p>\n\n<p>►&nbsp;<a href=\"https://developer.mozilla.org/pt-BR/docs/Glossario/IIFE\">https://developer.mozilla.org/pt-BR/docs/Glossario/IIFE</a></p>\n\n<pre>\n<code class=\"language-javascript\">(function () {\n    ...\n})();</code></pre>\n\n<p>&nbsp;</p>\n', '2022-08-25 19:18:09', '2022-08-25 19:18:09');
...
--
ALTER TABLE `conteudo`
  MODIFY `id_conteudo` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=104;

--
-- AUTO_INCREMENT de tabela `conteudo_indice`
--
ALTER TABLE `conteudo_indice`
  MODIFY `id_conteudo_indice` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=104;
