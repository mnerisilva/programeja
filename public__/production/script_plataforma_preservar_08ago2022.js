    ...
    const _xContentIframe = document.querySelector('.x_content iframe');
    

    // prism - botão javascript-code do editor
    const _btnJavascriptCode = document.querySelector('.javascript-code');
    ...
    const _divExibeContentEditor = document.querySelector('.exibe-content-editor');

    _btnJavascriptCode.addEventListener('click', function(){
        console.log('clicou no _btnJavascriptCode');        
        Prism.highlightAll();
        //_editorOne.innerHTML = `${_editorOne.innerHTML}<code class="language-css line-numbers">cole seu código aqui ...</code>`;       
        //_editorOne.innerHTML = `${_editorOne.innerHTML}<pre class="code"><code class="brush: js line-numbers language-js">cole seu código aqui ...</code></pre>`;     
        $(_editorOne).append(`<pre class="code"><code class="brush: js line-numbers language-js">// cole seu código aqui ...</code></pre><div></div>`);     
        Prism.highlightAll();
    });

    _editorOne.addEventListener('change', function(){
        console.log('RECEBEU O CONTEÚDO');
    })
    ...
    //let str = '';
    // evento botão salvar conteudo do editor da plataforma - ou seha: SALVA ANOTAÇÃO
    _btnSalvaTextoDoEditor.addEventListener('click', function(){
        let str = `
                    <div class="post mb-4 p-4">
                        <div class="post-header">
                            <span class="post-tools"><i class="fa-solid fa-pencil"></i> <i class="fa-solid fa-trash-can"></i></span>
                        </div>
                        <hr>
                        <div class="post-content">${_editorOne.innerHTML}</div>
                        <div class="post-footer"></div>
                    </div>
                    `;
        //_divExibeContentEditor.innerHTML = str;
        $(_divExibeContentEditor).prepend(str);
        _editorOne.innerHTML = '';
        
        var formData = {
            id_conteudo: $("#trilha_escolhida").val(),
            trilha_id: '',
            user_id: '',
            anotacao_conteudo: ''
        };
        ...
        $.ajax({
            ...
            /*$(_form_cadastro_de_user).on('hide.bs.modal', function (event) {
...
const _divMenuSection1 = document.createElement('div');
const _ulNavSideMenu1 = document.createElement('ul');
const _liTrilhaName1 = document.createElement('li');
const _ulNavChildMenu1 = document.createElement('ul');
const _h3_1 = document.createElement('h3');

const _divMenuSection2 = document.createElement('div');
const _ulNavSideMenu2 = document.createElement('ul');
const _liTrilhaName2 = document.createElement('li');
const _ulNavChildMenu2 = document.createElement('ul');
const _h3_2 = document.createElement('h3');



_divMenuSection1.classList.add('menu_section');
_ulNavSideMenu1.classList.add('nav', 'side-menu');
_ulNavChildMenu1.classList.add('nav', 'child_menu');

arrNewElements[1] = document.createElement('li');

arrNewElements[1].innerHTML = '<a href="index.html">Como INSERIR IMAGEM no HTML - COMPLETO!!!! Passo a</a>';

_ulNavChildMenu1.appendChild(arrNewElements[1]);

arrNewElements.pop();

arrNewElements[1] = document.createElement('li');

arrNewElements[1].innerHTML = '<a href="index.html">Estrutura básica</a>';
...
arrNewElements[1].innerHTML = '<a href="index.html">O elemento Head</a>';

_ulNavChildMenu1.appendChild(arrNewElements[1])

_liTrilhaName1.innerHTML = `<a><i class="fa-solid fa-list-ul"></i><span> Primeiro Html </span><span class="fa fa-chevron-down"></span></a>` 

_liTrilhaName1.appendChild(_ulNavChildMenu1);

_ulNavSideMenu1.appendChild(_liTrilhaName1)

_divMenuSection1.appendChild(_ulNavSideMenu1);

let _categoriaName1 = 'Html';

_h3_1.innerHTML = `<span class="badge badge-secondary">${_categoriaName1}</span> <span> <i class="fa fa-arrow-down"></i><small>trilhas</small></span>`;
...
_divMenuSection2.classList.add('menu_section');
_ulNavSideMenu2.classList.add('nav', 'side-menu');
_ulNavChildMenu2.classList.add('nav', 'child_menu');

arrNewElements = [];

arrNewElements[1] = document.createElement('li');

arrNewElements[1].innerHTML = '<a href="index.html">Aprendendo Lógica de Programação</a>';

_ulNavChildMenu2.appendChild(arrNewElements[1]);

arrNewElements = [];

arrNewElements[1] = document.createElement('li');

arrNewElements[1].innerHTML = '<a href="index.html">Lógica de Programação - Aula 01 - Introdução</a>';

_ulNavChildMenu2.appendChild(arrNewElements[1]);

_liTrilhaName2.innerHTML = `<a><i class="fa-solid fa-list-ul"></i><span>  Html como você nunca viu </span><span class="fa fa-chevron-down"></span></a>` 

_liTrilhaName2.appendChild(_ulNavChildMenu2);

_ulNavSideMenu2.appendChild(_liTrilhaName2)

_divMenuSection2.appendChild(_ulNavSideMenu2);

let _categoriaName2 = 'Html';

_h3_2.innerHTML = `<span class="badge badge-secondary">${_categoriaName2}</span> <span> <i class="fa fa-arrow-down"></i><small>trilhas</small></span>`;



_xxx.appendChild(_h3_1);
_xxx.appendChild(_divMenuSection1);

_xxx.appendChild(_h3_2);
_xxx.appendChild(_divMenuSection2);



const _linkDaTrilha = document.querySelectorAll('.xxx .nav.side-menu li a');

_linkDaTrilha.forEach(function(item){
   item.addEventListener('click', function(e){
    _linkDaTrilha.forEach(function(item){
        $(item).closest('li').removeClass('active');
        $(item).closest('li').find('ul').css({display: "none"});
    })
       console.log('cliqui no link da trilha do menu');
       $(e.target).closest('li').addClass('active');
       let _display = 'block'
       $(e.target).closest('li').find('ul').css({display: _display});
   });
});*/
...
_innerHtml = _innerHtml +` <h3><span class="badge badge-secondary">${item.abrev_categoria}</span> <span> <i class="fa fa-arrow-down"></i><small>trilhas</small></span></h3>`+
                                ...
                                <ul class="nav side-menu">
                                    <li class="trilha-link-menu"><a><i class="fa-solid fa-list-ul"></i><span> ${item.trilha_name} </span><span class="fa fa-chevron-down"></span></a>` +
                                        `<ul class="nav child_menu">` +
                                            `<li><a href="" data-id_conteudo="${item.id_conteudo}" data-conteudo_codigoyoutube="${item.conteudo_codigoyoutube}" data-conteudo_descricao="${item.conteudo_descricao}">${item.conteudo_descricao}</a></li>`
 ...
 _innerHtml = _innerHtml +              `</ul>
                        ...
                        if(cat == item.abrev_categoria && tri == item.trilha_name){
_innerHtml = _innerHtml +                  `<li><a href="" data-id_conteudo="${item.id_conteudo}" data-conteudo_codigoyoutube="${item.conteudo_codigoyoutube}" data-conteudo_descricao="${item.conteudo_descricao}">${item.conteudo_descricao}</a></li>`
