            ...
            <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
              ...
              <div class="menu_section">
                <ul class="nav side-menu">
                  <li><a class="trilha-link-menu"><i class="fa-solid fa-list-ul"></i><span> Primeiro Html </span><span class="fa fa-chevron-down"></span></a>
              ...
              <div class="menu_section">
                <ul class="nav side-menu">
                  <li><a class="trilha-link-menu"><i class="fa-solid fa-list-ul"></i><span> Html como você nunca viu </span><span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
              ...
              <div class="menu_section">
                <ul class="nav side-menu">
                  <li><a class="trilha-link-menu"><i class="fa-solid fa-list-ul"></i><span> Iniciando com lógica de programação </span><span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="e_commerce.html">Aprendendo Lógica de Programação</a></li>
                      <li><a href="projects.html">Lógica de Programação - Aula 01 - Introdução</a></li>
                    </ul>
                      ...
                      <div class="row">
                        <div class="col-md-6 mt-2">
                              <div class="embed-responsive embed-responsive-16by9">
                                  <iframe class="embed-responsive-item" width="640" height="360" src="https://www.youtube.com/embed/mHW1Hsqlp6A?enablejsapi=1&version=3&playerapiid=ytplayer&showinfo=0&modestbranding=1&fs=1&rel=0" autoplay="1" allowfullscreen=""></iframe>
                              </div> 
                          <div class="exibe-content-editor panel"></div>             
                          
                        </div>
                        <div class="col-md-6 mt-2 _editor"> 
                          ...
                          <a class="btn javascript-code" title="Redo (Ctrl/Cmd+Y)"><i class="fa-brands fa-js"></i></a>
                          </div>
                          </div>
                          ...
                          <textarea class="resizable_textarea form-control" placeholder="This text area automatically resizes its height as you fill in more text courtesy of autosize-master it out..."></textarea>
                            ...
                            <button class="btn btn-secondary salva-texto-do-editor" type="button">Salvar</button>
                          </div> 
